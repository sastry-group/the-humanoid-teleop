...
class Inspire_Controller:
    def __init__(self, left_hand_array, right_hand_array, dual_hand_data_lock = None, dual_hand_state_array = None,
        ...
        self.HandState_subscriber.Init(lambda msg: setattr(self, 'latest_hand_msg', msg))
        ...
        while True:
            # print("Subscriber thread: ", self.subscribe_state_thread.is_alive())
            # print("Subscriber update: ", self.HandState_subscriber.Read())
            print("dds loop: ", self.right_hand_state_array[0:6])
    ...
    def _subscribe_hand_state(self):
        while True:
            hand_msg = getattr(self, 'latest_hand_msg', None)            # print("hand_msg: ", hand_msg)
